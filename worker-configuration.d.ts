/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: d26d38692233e49fdd37cd356155781a)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	CONTACT_FROM: 'NAPARC Search <contact@naparcsearch.com>';
	GEOAPIFY_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'CONTACT_FROM' | 'GEOAPIFY_KEY' | 'RESEND_API_KEY' | 'CONTACT_TO'>
	> {}
}
